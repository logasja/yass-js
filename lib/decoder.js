...
var JpegImage = (function jpegImage() {
  ...
  constructor.prototype = {
    ...
    parse: function parse(data) {
      ...
      this.quant_tables = 
      {
        Y: components[0] ? components[0].quantizationTable : undefined, // Y channel quantization table
        U: components[1] ? components[1].quantizationTable : undefined, // U channel quantization table
        V: components[2] ? components[2].quantizationTable : undefined  // V channel quantization table
      }
    },
    getData: function getData(width, height) {
      ...
      if(this.opts.withYCbCr) {
        ...
        this.YCbCr = {
          ...
          Cb: this.components.length > 1 ? new Array(height).fill(new Uint8Array(width)) : undefined,
          Cr: this.components.length > 2 ? new Array(height).fill(new Uint8Array(width)) : undefined
        };
      }
...
function decode(jpegData, userOpts = {}) {
  ...
  try {
    ...
    var image = {
      ...
      dct_coeffs: decoder.dct_coeffs,
      quant: decoder.quant_tables,
      YCbCr: undefined
    };
  } catch (err){
